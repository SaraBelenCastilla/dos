    ...
    <>
     ...
     >
        ...
        >
            ...
            viewport={{once: false, amount:.5}}
            >
                <p>en una gran multinacional, donde cada día es exactamente igual: correos, llamadas,
</p>
<p> reuniones sin fin… el mismo almuerzo en el restaurante de la esquina: </p>
<p >el sándwich del día y un café americano.</p>
<p className='segunda__p'>Una rutina perfecta para desaparecer sin que nadie lo perciba.</p>
            </motion.div>
